...
public class NewMainFrame extends JFrame implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		...
		// 현재 구매 확인 : 선택한 번호가 적용된 창 출력
		...
		} else if (o.equals(btnMoneyCheck)) { // 금액조회
		} else if (o.equals(btnStats)) { // 통계
			...
			try {
				...
				if (lottoCount < 1) {
					...
					PurchaseDialog pcd = new PurchaseDialog(lottoRecordList, curLottoRecord, frame);
					LottoData[] ld = pcd.purchaseMany(lottoCount);
					curLottoRecord.addBuyLotto(ld);
